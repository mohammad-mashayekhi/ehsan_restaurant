...
class DailyReportForm(forms.ModelForm):
    ...
    total_sales = forms.DecimalField(label='جمع فروش', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder price-input': 'جمع فروش', 'min': 0 , 'readonly': True}), required=False, initial=0)
    ...
    total_expenses = forms.DecimalField(label='جمع هزینه‌ها', widget=forms.TextInput(attrs={'class': 'form-control price-input', 'placeholder': 'جمع هزینه‌ها', 'min': 0 , 'readonly': True }), required=False, initial=0)
