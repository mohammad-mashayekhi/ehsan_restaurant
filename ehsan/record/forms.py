...
class DailyReportForm(forms.ModelForm):
    ...
    sales_charity = forms.DecimalField(label='خیریه', widget=forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'خیریه / هیات', 'min': 0}), required=False, initial=0)
    sales_charity1 = forms.DecimalField(label='هیات', widget=forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'سفارشات', 'min': 0}), required=False, initial=0)
    ...
    salaries = forms.DecimalField(label='اضافه کاری/حقوق', widget=forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'حقوق', 'min': 0}), required=False, initial=0)
    hall = forms.DecimalField(label='سالن', widget=forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'اضافه کاری', 'min': 0}), required=False, initial=0)
    ...
    delivery = forms.DecimalField(label='پیک', widget=forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'غذای پرسنل', 'min': 0}), required=False, initial=0)
