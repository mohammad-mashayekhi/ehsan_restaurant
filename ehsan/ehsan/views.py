...
def dashboard(request):
    ...
    last_entry_in_date = convert_to_jalali(last_entry_in.date) if last_entry_in else None
    ...
    last_entry_out_date = convert_to_jalali(last_entry_out.date) if last_entry_out else None
    ...
    last_sale_info_date = convert_to_jalali(last_sale_info.date_created) if last_sale_info else None
    ...
    last_price_update_date = convert_to_jalali(last_price_update.date) if last_price_update else None
    last_price_update_today = is_today(last_price_update.date) if last_price_update else False

    context = {
        'today_date':today_date,
        'jalali_date': jalali_date,
        'last_entry_in_date': last_entry_in_date,
        'last_entry_in_today': last_entry_in_today,
        'last_entry_out_date': last_entry_out_date,
        'last_entry_out_today': last_entry_out_today,
        'last_sale_info_date': last_sale_info_date,
        'last_sale_info_today': last_sale_info_today,
        'last_price_update_date': last_price_update_date,
        'last_price_update_today': last_price_update_today,
    }
